...
int array_min(int array[], size_t len)
{
    ...
    for(size_t i = 1; i < len; i++)
        minArr = array[i] < minArr ? array[i]:minArr;
    return minArr;
}
...
int array_max(int array[], size_t len)
{
    int maxArr = array[0];
    for(size_t i = 1; i < len; i++)
        maxArr = array[i] > maxArr ? array[i]:maxArr;
    return maxArr;
}
...
size_t array_min_index(int array[], size_t len)
{
    ...
    {
        index = array[i] < min_arr?i:index;
        min_arr = index==i?array[i]:min_arr;
    }
...
size_t array_max_index(int array[], size_t len)
{
    ...
    for(size_t i = 0; i < len; i++)
    {
        index = array[i] > max_arr?i:index;
        max_arr = index==i?array[i]:max_arr;
    }
